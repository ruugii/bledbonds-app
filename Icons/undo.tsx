...
export default function Undo(props: any) {
  return (
    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M5.93782 15.5C5.32344 14.4359 5 13.2288 5 12C5 10.7712 5.32344 9.56413 5.93782 8.5C6.5522 7.43587 7.43587 6.5522 8.5 5.93782C9.56413 5.32344 10.7712 5 12 5" stroke="rgb(255, 255, 255)" stroke-width="2" stroke-linecap="round"/>
    </Svg>
  )
}